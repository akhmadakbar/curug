...
{
    // default connection
    public static $dbname = 'fms-narogong'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = 'n4r0g0ngb0g0r'; // // Your database password
    public static $dbhost = '10.3.2.16'; // Your database host, 'localhost' is default.
    ...
    public static $column_cut = 255; // Sets the maximum number of characters in the column.
