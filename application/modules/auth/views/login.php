...
<html lang="en">
	<head>
		...
		<title>Login Page - Monografi System</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Monografi</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Kecamatan Curug</h4>
							</div>
