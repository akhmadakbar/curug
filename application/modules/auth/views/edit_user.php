...
<?php $username = array(
	...
	?>
<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("auth/edit_user/".$id, $attrib);?>
<div class="form-group">
  <label class="control-label col-xs-2" for="username"><?php echo $this->lang->line("username"); ?></label>
  <div class="col-xs-10"> <?php echo form_input($username);?> </div>
</div>
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-xs-10">
	...
	<input id="file-0" class="file" type="file" name="photo">
	</div>
</div>
<!--
<div class="form-group">
			...
			<div class="input-group">
					<span class="input-group-btn">
							<span class="btn btn-primary btn-file">
									Browse&hellip; <input type="file" id="photo" name="photo" multiple>
							</span>
					</span>
						<?php //echo form_input($photo);?> 
			</div>
...
<?php echo form_close();?>
    ...
    $("#file-0").fileinput({
        'allowedFileExtensions' : ['jpg', 'png','gif'],
				initialPreview: [
						"<img src='<?php //print_r($photo['value']);
											if(($photo['value'] !== null) && ($photo['value'] !== "")){
												echo base_url()."assets/files/photo/".$photo['value'];
											} else {
												echo base_url()."assets/img/photo.jpg";
											}
									?>' class='file-preview-image' alt='Photo' title='Photo'>",
						// "<img src='<?php echo base_url().'assets/files/photo/'.$user->photo;?>' class='file-preview-image' alt='Photo' title='Photo'>",
				],				
    });
