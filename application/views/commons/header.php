...
<html lang="en">
	<head>
		...
		<?php if(isset($load_css)){$this->load->view($load_css);}?>
								...
								<img class="nav-user-photo" src="									
									<?php 
										if((USER_PHOTO !== null) && (USER_PHOTO !== '')){
												echo base_url().'assets/files/photo/'.USER_PHOTO;
											} else {
												echo base_url().'assets/images/avatars/user.jpg';
											}
									?>" alt="<?php echo USER_NAME;?>'s Photo"
								/>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<!--<li class="<?php //echo ($activeMenu == "master") ? "active" : ""; ?>">-->
					<li class="<?php echo ($activeMenu == "profile") ? "active" : ""; ?>">
						<!--<a href="<?php //echo base_url();?>master/coa">-->
						<a href="<?php echo base_url();?>#">
					...
					<li class="<?php echo ($activeMenu == "kepegawaian") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
					...
					<li class="<?php echo ($activeMenu == "pelayanan") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
							<i class="menu-icon fa fa-tachometer"></i>
					...
					<li class="<?php echo ($activeMenu == "kependudukan") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
					...
					<li class="<?php echo ($activeMenu == "pendidikan") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
							<i class="menu-icon fa fa-archive"></i>
					...
					<li class="<?php echo ($activeMenu == "activity") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
					...
					<li class="<?php echo ($activeMenu == "kesehatan") ? "active" : ""; ?>">
						<a href="<?php echo base_url();?>#">
