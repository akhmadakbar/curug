                ...
                default:
                    ...
                    foreach ($out as $b=>$object) {
                      ...
                      //  eval("\$this->pointer=&"."\$this->array$k".";");
                        ...
                        // elseif($k=='groupHeader'){
                             // $this->pointer=&$this->arraygroupHeader;
                        // $this->groupheaderbandheight=$object["height"]+0;
                        // }
                        // elseif($k=='groupFooter'){
                             // $this->pointer=&$this->arraygroupFooter;
                        // $this->groupfooterbandheight=$object["height"]+0;
                        // }
                        elseif($k=='pageFooter'){
